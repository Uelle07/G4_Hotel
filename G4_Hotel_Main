...
public class HotelG4_MethodDesigns {
    ...
    {         
        ...
        Scanner room_choice = new Scanner(System.in);
        Scanner confirmation = new Scanner(System.in);
        Scanner number_of_guests = new Scanner(System.in);
        Scanner number_of_nights = new Scanner(System.in);        
        ...
        while(true) 
        {
            ...
            System.out.println();
            Program = program.next().toUpperCase().charAt(0);
            
            if(Program == 'X') //Put this down there for it to be able to read the Name variable
            {
            ...
            if(Program == 'C') 
            {
                ...
                char Gender = gender.next().toUpperCase().charAt(0);
                ...
                {   
                    do
                    {
                        ...
                        Gender = gender.next().toUpperCase().charAt(0);                
                ...
                while(true) 
                {
                    ...
                    Room_Choice = room_choice.next().toUpperCase().charAt(0);
                   
                    switch(Room_Choice) 
                    {
                        case 'A': 
                            System.out.println("Are you sure that you are choosing the Standard Room? Y/N");
                            Confirmation = confirmation.next().toUpperCase().charAt(0);
                            ...
                            if(Confirmation == 'Y') 
                            {
                                ...
                                do
                                {
                                    ...
                                    Number_Of_Guests = number_of_guests.nextInt();
                                ...
                                if(Confirmation == 'Y') 
                                {
                                    ...
                                    do
                                    {
                                        ...
                                        Number_Of_Nights = number_of_nights.nextInt();
